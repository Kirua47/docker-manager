    ...
    <nav className="hidden md:flex flex-col w-sidebar_width h-full px-md py-lg bg-background border-r border-outline-variant fixed left-0 top-0 z-20">
      ...
      <div className="mt-auto pt-lg border-t border-outline-variant flex flex-col gap-sm">
        ...
        <button 
          ...
          className="flex items-center gap-md px-md py-sm rounded text-error hover:bg-error-container/20 transition-colors cursor-pointer active:opacity-80 text-left w-full"
        >
          <span className="material-symbols-outlined text-error">logout</span>
          <span className="font-title-sm text-title-sm font-medium">Sign Out</span>
        </button>
